...
func _ready() -> void:
	...
	# Doubles as the length of a measure
	first_beat_offset_ms = int(0.314 * 1000)
	#first_beat_offset_ms = int(((60.0 / bpm) * 4.0) * 1000)
...
## Starts AudioStreamPlayer and smoothing.
func conductor_play() -> void:
	var filter_args := {
